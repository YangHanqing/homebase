...
(function () {
  const DICT = {
    en: {
      ...
      "project.deleteConfirm": "Remove \"{name}\" from the sidebar? Its tmux session, if any, keeps running and stays reachable from a terminal directly.",
    ...
    zh: {
      ...
      "project.deleteConfirm": "从侧栏移除“{name}”？它的 tmux session（如果有）不会被关闭，仍可以直接从终端访问。",
