...
(function () {
  const DICT = {
    en: {
      ...
      "project.add.hint": "A project is a folder. Adding one opens a window there.",
      ...
      "s.newWindowDirSame": "Current window, or the project folder",
    ...
    zh: {
      ...
      "project.deleteBtn": "删除",
      "project.add.title": "新建项目",
      "project.add.hint": "项目就是一个文件夹，新建后会在该目录打开一个窗口。",
      ...
      "s.newWindowDirSame": "当前窗口；项目内则用项目目录",
